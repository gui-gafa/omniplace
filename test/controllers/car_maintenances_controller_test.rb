...
class CarMaintenancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create car_maintenance" do
    assert_difference('CarMaintenance.count') do
      post car_maintenances_url, params: { car_maintenance: { car_id: @car_maintenance.car_id, date: @car_maintenance.date, description: @car_maintenance.description, value: @car_maintenance.value, warranty: @car_maintenance.warranty } }
    end
  ...
  test "should update car_maintenance" do
    patch car_maintenance_url(@car_maintenance), params: { car_maintenance: { car_id: @car_maintenance.car_id, date: @car_maintenance.date, description: @car_maintenance.description, value: @car_maintenance.value, warranty: @car_maintenance.warranty } }
